...
2. Select **Transcribe recording**. VoiceQA uses the accuracy-focused Whisper Large v3 model and shows the completed transcript for review. Longer recordings are processed in ordered one-minute sections and joined before grading to reduce skipped dialogue.
